...
class DriversMyOrdersWidget extends StatelessWidget {
  var onPressOrderDetails;
  var onPressOrderStatusChange;
  String buttonOrderStatus;
  DriversMyOrdersWidget(
      {Key? key,
      required this.screenSize,
      required this.onPressOrderDetails,
      required this.productDetail,
      required this.buttonOrderStatus,
      required this.onPressOrderStatusChange})
      : super(key: key);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: onPressOrderStatusChange,
                      child: Container(
                        height: screenSize.height * 0.05,
                        width: screenSize.width * 0.38,
                        padding: const EdgeInsets.fromLTRB(10, 0, 10, 0),

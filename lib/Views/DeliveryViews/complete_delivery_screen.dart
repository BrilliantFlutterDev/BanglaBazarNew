...
class CompletedDeliveryScreen extends StatefulWidget {
  ...
  @override
  _CompletedDeliveryScreenState createState() =>
      _CompletedDeliveryScreenState();
}

class _CompletedDeliveryScreenState extends State<CompletedDeliveryScreen> {
  ...
  void initState() {
    ...
    statusFilterValueChoose = 'Delivered';
